const canvas = document.getElementById('tetris');
        ...
        function arenaSweep() {
            ...
            // Verificar se deve aumentar o nível (a cada 50 pontos)
            const newLevel = Math.floor(score / 50) + 1;
            if (newLevel > level) {
                level = newLevel;
                // Aumentar a velocidade: diminuir o intervalo de queda
                dropInterval = Math.max(100, baseDropInterval - (level - 1) * 100);
            }
        }
